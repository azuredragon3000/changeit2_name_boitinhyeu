...
public class UtilsRoot {
    private static final int ROOT_STATUS_NOT_CHEKED =0;
    ...
    public static boolean isRooted(){
        ...
        if(rootStatus == ROOT_STATUS_NOT_CHEKED){
    ...
    private static boolean isRootedByExecutingCommand() {
    ...
    private static boolean isRootedByFileSU() {
        try{
    ...
    private static boolean isRootByBuildTag() {
