...
public class UninstallInBackground extends AsyncTask<Void, String, Boolean> {
    ...
    protected void onPostExecute(Boolean status) {
        ...
        if (status) {
            ...
            UtilsDialog.showTitleContent(context, context.getResources().getString(R.string.dialog_root_required),
                    context.getResources().getString(R.string.dialog_root_required_description));
        }
    }
}