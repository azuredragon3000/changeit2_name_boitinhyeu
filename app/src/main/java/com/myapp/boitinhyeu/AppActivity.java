...
public class AppActivity extends AppCompatActivity {
    ...
    private void setInitialConfiguration() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            getWindow().setStatusBarColor(UtilsUI.darker(appPreferences.getPrimaryColorPref(context.getResources().getColor(R.color.primary)), 0.8));
            toolbar.setBackgroundColor(appPreferences.getPrimaryColorPref(context.getResources().getColor(R.color.primary)));
            if (!appPreferences.getNavigationBlackPref()) {
                getWindow().setNavigationBarColor(appPreferences.getPrimaryColorPref(context.getResources().getColor(R.color.primary)));
            }
        }
    }
    ...
    private void setScreenElements() {
        ...
        Drawable icon2 = null;
        try {
            icon2 = context.getPackageManager().getApplicationIcon(pkg);
        ...
        // Configure Colors
        header.setBackgroundColor(appPreferences.getPrimaryColorPref(context.getResources().getColor(R.color.primary)));
        fab_share.setColorNormal(appPreferences.getFABColorPref(context.getResources().getColor(R.color.fab)));
        fab_share.setColorPressed(UtilsUI.darker(appPreferences.getFABColorPref(context.getResources().getColor(R.color.fab)), 0.8));
        fab_hide.setColorNormal(appPreferences.getFABColorPref(context.getResources().getColor(R.color.fab)));
        fab_hide.setColorPressed(UtilsUI.darker(appPreferences.getFABColorPref(context.getResources().getColor(R.color.fab)), 0.8));
        fab_buy.setColorNormal(appPreferences.getFABColorPref(context.getResources().getColor(R.color.fab)));
        fab_buy.setColorPressed(UtilsUI.darker(appPreferences.getFABColorPref(context.getResources().getColor(R.color.fab)), 0.8));
                        ...
                        public void onActivityResult(ActivityResult result) {
                            if(result.getResultCode() == RESULT_OK){
                                UtilsDialog.showTitleContent(context, "Information",
                                        "clear cached");
                            }else if(result.getResultCode() == OsConstants.EIO){
                                UtilsDialog.showTitleContent(context, "Information",
                                        "some error happened");
        ...
        //if (MLManagerApplication.isPro()) {
            ...
            if (UtilsRoot.isRooted()) {
                UtilsApp.setAppHidden(
                        context,
                        fab_hide,
                        UtilsApp.isAppHidden(appInfo, appsHidden),
                        ...
                        R.drawable.ic_visibility_off_white);
                    ...
                    public void onClick(View view) {
                        ...
                        /*if (UtilsApp.isAppHidden(appInfo, appsHidden)) {
                            ...
                            if (hidden) {
                                ...
                                UtilsDialog.showSnackbar(activity, getResources().getString(R.string.dialog_reboot),
                                        getResources().getString(R.string.button_reboot), null, 3).show();
                            }
                        } else {
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        UtilsApp.setAppFavorite(
                context,
                item_favorite,
                UtilsApp.isAppFavorite(appInfo.getAPK(), appsFavorite),
